# Zachary Murphy             11-20-25
# Lab #10 Section F

# This code will refactor the chimp.py file.
...
class Entity(pygame.sprite.Sprite):
    ...
    def __init__(self, name, colorkey, scale, data_dir):
        super().__init__()
...
class Fist(Entity):
    ...
    def __init__(self, name, colorkey, scale, data_dir):
        self.image, self.rect = super().__init__(name, colorkey, scale, data_dir)  # call Sprite initializer
