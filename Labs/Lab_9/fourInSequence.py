# Zachary Murphy             10-27-2025
# Assignment #4, Lab Section F, Lecture Section 4
# This code will allow the user to play the classic game of four in sequence (Connect 4) against an AI or another person.
...
def checkForNextMoveWin(board, playerNumber):
    ...
    for column in range(0, len(board[0])):
        ...
        if row != -1:
            ...
            placePiece(board, row, column, piece)
            ...
            if checkWinner(board, playerNumber):
                ...
                placePiece(board, row, column, empty)
...
def checkWinner(board, playerNumber):
    ...
    for column in range(0, len(board)):
        for row in range(0, len(board[0]) - 4):
    ...
    for row in range(0, len(board[0]) - 4):
        for column in range(3, len(board)):
            if board[row][column] == piece and board[row+1][column-1] == piece and board[row+2][column-2] == piece and board[row+3][column-3] == piece:
                return True
...
def main():
    ...
    while running:
        ...
        if choice == "p":
            ...
            print("The player will select whether tehy want to play against the computer, or another person.")
            print("1 for computer, 2 for person.")
            print("Then, player 1 will take their turn by selecting which column they want their piece to be put in.")
            print("Player 1's turn now ends and player 2 takes their turn. Player 2 is either the computer or another person.")
            print("Players continue taking turns until one of them gets four of their pieces in a row, or there is a draw.")
